// Task 01
// Напишите стрелочную функцию f01 принимающую два параметра - числа и возвращающая их произведение.
...
// Task 02
// Напишите стрелочную функцию f02 которая принимает строку и возвращает ее очищенную по краям (от пробелов),
// и приведенную к нижнему регистру. Тип функций, аргументов во всех задачах спринта - прописываете самостоятельно.
...
// Task 03
// Напишите стрелочную функцию f03 которая принимает строку и возвращает ее очищенную по краям (от пробелов),
...
const f06 = (): void => {
  let str1: string = String(
    (<HTMLInputElement>document.querySelector(".i-61")).value
  );
  let str2: string = String(
    (<HTMLInputElement>document.querySelector(".i-62")).value
  );
  let out = "";
...
// Задайте параметрам значение по умолчанию 0 и 100. Тип функций, аргументов во всех задачах спринта - прописываете самостоятельно.

const f08 = (num1: number = 0, num2: number = 100): number => {
...
// Task 09
// Напишите стрелочную функцию f09 которая возвращает строку вида 'rgb(xxx,xxx,xxx)', где xxx - случайные числа от 0 до 255
// генерируемые функцией f08. Тип функций, аргументов во всех задачах спринта - прописываете самостоятельно.
...
// Task 10
// Напишите стрелочную функцию f10 которая при каждом клике увеличивает переменную angle на 30, а потом присваивает блоку .out-10
// свойство transform: rotate(angledeg) где angle - значение из переменной angle. Тип функций, аргументов во всех задачах
...
const f10 = (): void => {
  angle += 30;
  let block = <HTMLDivElement>document.querySelector(".out-10");
